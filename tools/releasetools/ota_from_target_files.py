...
""" % bcb_dev)
  ...
  script.Print("*                  MaxiCM                 ");
  script.Print("******************************************");
  script.Print("*           Created By MaxiCM Team        ");
  script.Print("******************************************");    
...
#  else:
  ...
  script.Print("Thank you for using MaxiCM")
  script.Print("We hope you enjoy it")

  script.Print(" __  __            _  _____ __  __ "); 
  script.Print("|  \/  |          (_)/ ____|  \/  |");
  script.Print("| \  / | __ ___  ___| |    | \  / |");
  script.Print("| |\/| |/ _, \ \/ / | |    | |\/| |");
  script.Print("| |  | | (_| |>  <| | |____| |  | |");
  script.Print("|_|  |_|\__,_/_/\_\_|\_____|_|  |_|");
